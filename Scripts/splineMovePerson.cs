...
namespace SWS
{
    ...
    /// <summary>
    public class splineMovePerson : MonoBehaviour
    {
        Animator m_Animator;
        string currentState;
        ...
        List<Transform>  allPaths = new List<Transform>() ;
        ...
        void Start()
        {
            ...
            Transform randomChild = allPaths[UnityEngine.Random.Range(0,allPaths.Count)];
            PathManager randomPath = randomChild.GetComponent<PathManager>();
        ...
        public void StartMove()
        {
            ...
            if (pathContainer == null)
            {
                ...
                var scaleOffsetMax = 0.05f;

                var randomScale = new Vector3(UnityEngine.Random.Range(-scaleOffsetMax, scaleOffsetMax), 1f, UnityEngine.Random.Range(-scaleOffsetMax, scaleOffsetMax));
